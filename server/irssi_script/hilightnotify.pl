...
Irssi::settings_add_str ('hilightnotify', 'hilight_cmd_on_hilight', '/var/www/user/data/bin/irssi_highlight.pl');
Irssi::settings_add_str ('hilightnotify', 'hilight_cmd_on_dehilight', '/var/www/user/data/bin/irssi_dehighlight.pl');
...
sub hilight   {
   my ($dest, $text, $stripped) = @_;
   run_cmd($hilight_cmd_on_hilight . " \"" . $dest->{target} . "\" \"" . $stripped . "\"")
}
